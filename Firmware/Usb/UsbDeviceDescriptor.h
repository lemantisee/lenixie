...
{
public:
    std::span<uint8_t> getStringDescriptor(usb::UsbSpeed speed,
                                           StringIndex strIndex) const override;
...
private:
    ...
    void fillSerialNumber(uint8_t *value1, uint8_t value1Len, uint8_t *value2,
